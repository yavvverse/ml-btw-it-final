                ...
                {isExpanded && (
                  ...
                  >
                    <div className="space-y-5 sm:space-y-6 pt-5 sm:pt-6 border-t border-white/5 mt-5 sm:mt-6">
                      ...
                      <p>
                        Зараз я більше фокусуюсь не на тому, "щоб працювало", а
                        на тому, як людина взаємодіє з продуктом. Чи зрозумілий
                        інтерфейс? Чи відчувається логіка в кожному елементі? Чи
                        є в цьому щось живе — анімація, пасхалка, деталь, яка
                        змушує затриматись і посміхнутись? Саме це відрізняє
                        сайт від{" "}
                      ...
                      <p>
                        ...
                        я провела КТ з трьома людьми. З{" "}
                        <span className="text-white font-medium">
